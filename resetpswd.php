...
<body>
    <h1 align='center' style="margin: 15px; color:green;font-weight: bold;font-family:'Times New Roman', Times, serif">
        PLEASE REMEMBER THIS TIME</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:yellow;font-family:'Times New Roman', Times, serif">The Fastest
        Courier Service Ever</P>
    <div>
        <h5><a href="index.php" style="float: right; margin-right:40px; color:blue; margin-top:0px">SignIn</a></h5>
    </div>
